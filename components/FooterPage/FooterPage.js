...
export default function FooterPage({ variant = '' }) {
    return (
        <div className={classNames(variant !== '' ? "absolute inset-0 flex" : '' )} style={{zIndex: '-1'}}>
            <footer aria-labelledby="footer-heading" style={{ backgroundColor: '#112d57' }} className={classNames(variant !== '' ? "mt-auto w-full" : "")}>
